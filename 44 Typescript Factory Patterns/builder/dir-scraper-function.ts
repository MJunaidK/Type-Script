...
const directoryScarper = (dirPath: string, fileReader: IFileReader) => {
  return fs
    .readdirSync(dirPath)
...
// fileReader has to go as an object not as a function as per the directoryScarper args
...
const output = directoryScarper('./data', fileReader);
console.log(output);
